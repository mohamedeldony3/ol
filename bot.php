			...
			if(isset($update->message)){
              ...
              $bot->sendphoto([ 'chat_id'=>$chatId,
                  'photo'=>"https://t.me/yffhfhchhf/935",
                   'caption'=>'𓊈 𝑊𝐸𝐿𝐿𝐶𝑀𝐸 𓊉 𓁹 التفعيل بواسطة @Remove44',
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'➕ اضافه حسابات وهميه ➕','callback_data'=>'login'],['text'=>'➖صفحه التحكم ➖','callback_data'=>'backakil']],
                       [['text'=>"قناتي ✔ ", 'url'=>"https://t.me/Remove44"],['text'=>"المطور ➿ ", 'url'=>"https://t.me/Ramo44"]],
          	...
          	if($config['mode'] != null){
                  ...
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          ...
                          [['text'=>' قناتي❗','url'=>'t.me/Remove44'],['text'=>'المطور❔','url'=>'t.me/Ramo44']],
                      ]
                  ])
                  ]);
          		    $config['mode'] = null;
...
اضغط في الاسفل لمراسله المطور 👇",
                								...
                								'reply_markup'=>json_encode([
                								          ...
                								          'inline_keyboard'=>[
                								                   ...
                								                   [['text'=>'اضغط لمراسله المطور 🗣','url'=>'t.me/Remove44']],
     ...
     $bot->sendMessage([
                  ...
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'قناتي','url'=>'t.me/Remove44'],['text'=>'تواصل','url'=>'t.me/Ramo44']],
                           [['text'=>'اشتراك بلبوت','url'=>'t.me/Ramosed_bot']],
